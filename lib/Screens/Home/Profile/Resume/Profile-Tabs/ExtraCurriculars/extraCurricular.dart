                ...
                child: RaisedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => NewExtraCurricular(old: false, extraCurriculars: extraCurriculars, index: extraCurriculars.length,)));
                  },
                  child: ListTile(
                    leading: Text(
                      'Add New Activity',
              ...
              ScrollConfiguration(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context1, int index) {
                    String start = extraCurriculars[index]['start'] == null
                        ? null
                    ...
                    info1 = extraCurriculars[index]['info'] == null ? '' : extraCurriculars[index]['info'][0];
                    info2 = extraCurriculars[index]['info'] == null ? '' : extraCurriculars[index]['info'][1];
                    return Column(
                      children: <Widget>[
                        Stack(
                          children: <Widget>[
                                ...
                                subtitle: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text('Organisation/Committee: ' +
                                        (extraCurriculars[index]['organisation'] ?? '')),
