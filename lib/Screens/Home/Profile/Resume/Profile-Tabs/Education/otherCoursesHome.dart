            ...
            for (int j = 0; j < allFiles[0].length; j++) {
              if (allFiles[0][j] != null) {
                final StorageReference storageReference = FirebaseStorage()
                    .ref()
                    .child(
                        "documents/${value.getString("email")}/${DateTime.now()}");
                          ...
                          onPressed: () async {
                            ...
                            for (int i = 0;
                              ...
                              formattedFrom = apiDateFormat.format(
                                  temp[nameOfOtherCourses[i]]['start']
                                      .toDate());
                              formattedFrom = formattedFrom + " 00:00:00+0000";
                              formattedTo = apiDateFormat.format(
                                  temp[nameOfOtherCourses[i]]['end'].toDate());
                            ...
                            for (int i = 0; i < allFiles.length; i++) {
                              if (i == 0) {
                                ...
                                for (int j = 0; j < allFiles[3].length; j++) {
                                  if (allFiles[3][j] != null) {
                                    temp[nameOfOtherCourses[j]]['certificate'] =
                                        temp2[3][j];
                                  }
                                }
                              }
