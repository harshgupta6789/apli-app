...
class Tenth extends StatefulWidget {
  ...
  const Tenth({Key key, @required this.x, this.allFiles, this.isUg}) : super(key: key);
  @override
                          ...
                          RaisedButton(
                              ...
                              onPressed: () async {
                                if(_formKey.currentState.validate()) {
                                  allFiles.add(file);
                                  if(widget.isUg)
                                    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Other(oth: education, allFiles: allFiles,)));
                                  else {
                                    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Other(oth: education, allFiles: allFiles,)));
//
                                  }
