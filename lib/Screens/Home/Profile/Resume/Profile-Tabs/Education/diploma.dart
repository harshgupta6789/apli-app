...
class Diploma extends StatefulWidget {
  ...
  const Diploma({Key key, @required this.xii, this.allFiles, this.isUg}) : super(key: key);
  @override
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        Container(
                          width: width * 0.35,
                          child: TextFormField(
                            initialValue: education['XII']['score'] == null ? '' : education['XII']['score'].toString(),
                            textInputAction: TextInputAction.next,
                            ...
                            decoration: x("Score"),
                            onChanged: (text) {
                              setState(() => education['XII']['score'] = int.tryParse(text));
                            },
                            validator: (value) {
                              if (value.isEmpty)
                          ...
                          RaisedButton(
                              ...
                              onPressed: () {
                                if(_formKey.currentState.validate()) {
                                  print(education);
                                  allFiles.add(file);
                                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Tenth(x: education, allFiles: allFiles, isUg: widget.isUg,)));
                                }
                              }),
                        ],
                      ),
