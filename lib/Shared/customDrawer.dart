  ...
  Future<List<String>> userInit() async {
    ...
    await Firestore.instance
        ...
        .then((snapshot) {
          ...
          if(lname == null) userData.add(fname);
          else userData.add(fname + ' ' + lname);
      ...
      child: Container(
        ...
        child: Column(
            children: [
              ...
              ListTile(
                dense: true,
                  title: Text("Notifications", style: TextStyle(fontWeight: FontWeight.bold, fontSize: fontSize),),
                  trailing: IconButton(
              ...
              ListTile(
                dense: true,
                  title: Text("Rate Your Experience", style: TextStyle(fontWeight: FontWeight.bold, fontSize: fontSize),),
                  trailing: IconButton(
                      icon: Icon(EvaIcons.arrowIosForward), onPressed: null),
                  onTap: () async {
                    const url =
              ...
              ListTile(
                dense: true,
                  title: Text("Refer A Friend", style: TextStyle(fontWeight: FontWeight.bold, fontSize: fontSize),),
                  trailing: IconButton(
                      icon: Icon(EvaIcons.arrowIosForward), onPressed: null),
                  onTap: () async {
                    const url =
              ...
              ListTile(
                dense: true,
                  title: Text("Report", style: TextStyle(fontWeight: FontWeight.bold, fontSize: fontSize),),
                  trailing: IconButton(
                      icon: Icon(EvaIcons.arrowIosForward), onPressed: null),
                  onTap: () async {
              ...
              ListTile(
                dense: true,
                  title: Text("Log Out", style: TextStyle(fontWeight: FontWeight.bold, fontSize: fontSize),),
                  trailing: IconButton(
                      icon: Icon(EvaIcons.arrowIosForward), onPressed: null),
                  onTap: () async {
